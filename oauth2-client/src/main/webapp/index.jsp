...
--%>
<%@page import="com.rajendarreddyj.google.auth.GoogleAuthHelper"%>
...
<div class="readme">
  ...
  <ul>
    ...
    <li>Set up allowed Redirect URIs at Google API &rarr; API
      Access. Input: http://localhost:8080/oauth2-client/index.jsp</li>
  </ul>
  ...
  <ol>
    ...
    <li>Compile the project (<b>$ gradle tomcatRun</b>)</li>
    <li>Deploy war to application server</li>
    <li>Browse to: <a href="http://localhost:8080/oauth2-client/">http://localhost:8080/oauth2-client/</a></li>
